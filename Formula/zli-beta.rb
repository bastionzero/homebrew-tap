...
class ZliBeta < Formula
  ...
  url "https://api.github.com/repos/bastionzero/zli/releases/assets/118622363", headers: ["Accept: application/octet-stream", "Authorization: bearer #{ENV["HOMEBREW_GITHUB_API_TOKEN"]}"]
  version "6.27.0-beta"
